...
> If this is a **simple linear task**, use a 🛠️ *How-to*.  
> If it’s about **understanding ideas**, use a 🧩 *Concept*.  
> If it defines a **reusable framework or system design**, use a 🧱 *Pattern*.  
